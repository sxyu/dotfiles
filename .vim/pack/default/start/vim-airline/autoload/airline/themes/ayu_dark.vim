" Normal mode
" (Dark)
let s:N1 = [ '#3D424D' , '#C2D94C' , 3  , 'NONE' ] " guifg guibg ctermfg ctermbg
let s:N2 = [ '#C2D94C' , '#304357' , 149 , 'NONE'  ] " guifg guibg ctermfg ctermbg
let s:N3 = [ '#B3B1AD' , '#0A0E14' , 145 , 'NONE'  ] " guifg guibg ctermfg ctermbg

" Insert mode
let s:I1 = [ '#3D424D' , '#39BAE6' , 9  , 'NONE'  ] " guifg guibg ctermfg ctermbg
let s:I2 = [ '#39BAE6' , '#304357' , 74  , 'NONE'  ] " guifg guibg ctermfg ctermbg
let s:I3 = [ '#B3B1AD' , '#0A0E14' , 145 , 'NONE'  ] " guifg guibg ctermfg ctermbg

" Visual mode
let s:V1 = [ '#3D424D' , '#FF8F40' , 8  , 'NONE' ] " guifg guibg ctermfg ctermbg
let s:V2 = [ '#FF8F40' , '#304357' , 209 , 'NONE'  ] " guifg guibg ctermfg ctermbg
let s:V3 = [ '#B3B1AD' , '#0A0E14' , 145 , 'NONE'  ] " guifg guibg ctermfg ctermbg
...
let g:airline#themes#ayu_dark#palette.replace = copy(g:airline#themes#ayu_dark#palette.insert)

...
let s:airline_c_normal   = [ '#9cffd3' , '#202020' , 15  , 'NONE' ]
...
let s:airline_c_insert = [ '#ffffff' , '#000080' , 15  , 'NONE'  ]
...
let s:airline_c_visual = [ '#ffffff' , '#5f0000' , 15  , 'NONE'  ]
...
let s:airline_c_commandline = [ '#9cffd3' , '#202020' , 15  , 'NONE' ]
